...
-->
  <xsl:template name="summary">
    ...
    <span id=":i18n:Note">Note</span>: <i id=":i18n:failures">failures </i> <span id=":i18n:anticipated">are one sort of problem while </span> <i id=":i18n:errors">errors </i> <span id=":i18n:unanticipated">are something else, maybe... the difference, no fucking clue.</span>
  </xsl:template>
